...
#ifndef __BOManager_H_
#define __BOManager_H_
...
class BOManager
{
	...
	static BOManager* m_pInstance; // Singleton pointer
	std::vector<BOClass*> m_lObject; //list of AABB
...
public:
	...
	*/
	...
	OUTPUT: BOClass* from the list
	*/
	BOClass* GetBoundingObject(uint a_nIndex);
	/*
	USAGE: returns the element specified by the index
	ARGUMENTS:
	...
	OUTPUT: BOClass* from the list
	*/
	BOClass* GetBoundingObject(String a_sIndex);
	/*
